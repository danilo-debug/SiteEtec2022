        ...
        <div class="col-12  background-color-main">
            ...
            <article class="row d-flex justify-content-center main-card"> <!-- Artigos Cursos Inicio -->
              ...
              <div id="postCurso" class="col-9 bg-white  rounded shadow"> <!-- Curso Administracao inicio -->
                ...
                <h1 class="display-4 d-flex justify-content-center">Segurança do Trabalho</h1>
                <img class="img-fluid h-25" src="imagen/Segurança.jpg">
                <hr class="my-4">
                <p class="lead">
                ...
                <p class="lead">
                Desenvolve ações educativas na área de saúde e segurança do trabalho. Orienta o uso de EPI e EPC. Coleta e organiza informações de saúde e de segurança no trabalho. Avalia e executa diversos programas de prevenção em SST, inclusive PPRA (Programa de Prevenção de Riscos Ambientais). Investiga, analisa acidentes e recomenda medidas de prevenção e controle.
                </p>
                </div>
