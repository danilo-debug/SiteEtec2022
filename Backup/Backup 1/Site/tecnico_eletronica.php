        ...
        <div class="col-12  background-color-main">
            ...
            <article class="row d-flex justify-content-center main-card"> <!-- Artigos Cursos Inicio -->
              ...
              <div id="postCurso" class="col-9 bg-white  rounded shadow"> <!-- Curso Administracao inicio -->
                ...
                <h1 class="display-4 d-flex justify-content-center">Técnico em Eletronica</h1>
                <img class="img-fluid h-25" src="imagen/eletronica.jpeg">
                <hr class="my-4">
                <p class="lead">
                O TÉCNICO EM ELETROELETRÔNICA é o profissional que elabora estudos e projetos de sistemas industriais, participando do desenvolvimento de processos e de produtos. Projeta e executa serviços elétricos, eletrônicos, eletromecânicos e hidráulicos e de telecomunicações; implementa propostas técnicas, instalando, configurando, mantendo e inspecionando sistemas e equipamentos. Procede à execução e ao controle da manutenção corretiva e preventiva de sistemas industriais.
                </p>
                </div>
