<?php 
 class CursoService
 {
 	...
 	{
 	 $query = "insert into tb_cursos (usuario_id,titulo,logotipo,capa,descricao) values (:usuario_id,:titulo,:logotipo,:capa,:descricao)";
        $stmt = $this->conexao->prepare($query);
       
        $stmt->bindValue(':usuario_id',$this->curso->__get('usuario_id'));
