        ...
        <div class="col-12  background-color-main">
            ...
            <article class="row d-flex justify-content-center main-card"> <!-- Artigos Cursos Inicio -->
              ...
              <div id="postCurso" class="col-9 bg-white  rounded shadow"> <!-- Curso Administracao inicio -->
                ...
                <h1 class="display-4 d-flex justify-content-center">Química</h1>
                <img class="img-fluid h-25" src="imagen/Quimica.png">
                <hr class="my-4">
                <p class="lead">
                O curso de Química da ETEC Pedro Badran, oferece laboratórios equipados e profissionais preparados para a formação técnica dos profissionais que estão engessando no mercado de trabalho.
                </p>
