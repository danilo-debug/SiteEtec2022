            ...
            <article class="row d-flex justify-content-center main-card"> <!-- Artigos Historia Inicio -->
              <div class="col-lg-8 col-md-12 bg-white  rounded shadow">

                <div class="jumbotron mt-5">
                <h1 class="display-4">Historia</h1>
                <img class="mt-3  mb-4" src="imagen/historia.jpg">
                <p class="lead">
                ...
                <hr class="my-4">
                <h5>Veja Nossa Galeria!</h5>
                <p class="lead">
                  <a class="btn btn-primary btn-danger" href="#" role="button">Ir para Galeria</a>
                </p>
                </div>
